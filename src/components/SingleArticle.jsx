				...
				<>
					<div className="single-article">
						...
						<div className="vote-buttons">
							<button
								className={hasVoted && upVoted ? "voted" : "not-voted"}
								onClick={upVote}
							>
								upvote
							</button>
							<button
								className={hasVoted && downVoted ? "voted" : "not-voted"}
								onClick={downVote}
							>
								downvote
							</button>
						...
						{hasVoted && upVoted ? (
							<p className="vote-status">Upvoted Article</p>
						) : null}
						{hasVoted && downVoted ? (
							<p className="vote-status">Downvoted Article</p>
						) : null}
						<PostComment
